	...
	if(isset($_SESSION['carritos'])){
		if(isset($_GET['id'])){
					...
					if($encontro==true){
						...
						$_SESSION['carritos']=$arreglo;
					}else{
						$nombre="";
						$precio=0;
						$imagen="";
						$re=mysqli_query($link,"select * from cama_hidroponica where id=".$_GET['id']);
...
<body>
	...
	?>
		...
		?>
		<center><a href="camasventa.php">Ver catalogo</a></center>
